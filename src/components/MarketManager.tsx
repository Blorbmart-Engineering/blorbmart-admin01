 ...
 * the server crops to 800px anyway, and a smaller upload is the difference
 * between saving and timing out on campus data.
 */
async function toCompressedDataUrl(file: File, maxSide = 1200): Promise<string> {
